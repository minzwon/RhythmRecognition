...
class Transpose:
    def __init__(self):
        self.audio_path = '/data1/ExBallroom/11p_audio'   # path of the raw audio
        self.npy_path = '/data1/ExBallroom/11p_npy'   # path of the numpy array
        self.target_audio_path = '/data1/ExBallroom/11p_audio_trp'    # path of the transposed audio
        self.target_npy_path = '/data1/ExBallroom/11p_npy_trp'  # path of the transposed numpy array
        self.target_bpm_path = '/data1/ExBallroom/11p_bpm_vec'  # path of the bpm vector
