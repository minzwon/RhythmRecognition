...
class Extract:
    def __init__(self):
        self.npy_16k_path = '/data1/ExBallroom/11p_npy'
        self.npy_trp_path = '/data1/ExBallroom/11p_npy_trp'
        self.spec_16k_path = '/data1/ExBallroom/11p_spec'
        self.spec_trp_path = '/data1/ExBallroom/11p_spec_trp'
