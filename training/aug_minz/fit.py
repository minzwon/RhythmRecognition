...
class Learner:
    def fit_gen(self,
            ...
            weight_checkpoint='checkpoints/aug_minz.{epoch:02d}.hdf5',
            out_model_fname='aug_minz.keras',
            gpu_id = 0,
        ...
        tensor_board = TensorBoard(log_dir='tensorboard/aug_minzi', histogram_freq = 0, write_graph=True, write_images=True,batch_size=batch_size)
        ...
        self.model.fit_generator(generator_tr,
                                 steps_per_epoch = int(204505/batch_size)+1,
                                 epochs=epochs,
                                 verbose=1,
                                 callbacks=callbacks,
                                 validation_data=generator_val,
                                 validation_steps=int(2221/batch_size),
                                 initial_epoch=0)
