...
class Learner:
    def fit_gen(self,
            ...
            weight_checkpoint='checkpoints/spec_normal.{epoch:02d}.hdf5',
            out_model_fname='spec_normal.keras',
            gpu_id = 0,
        ...
        tensor_board = TensorBoard(log_dir='tensorboard/spec_normal', histogram_freq = 0, write_graph=True, write_images=True,batch_size=batch_size)
